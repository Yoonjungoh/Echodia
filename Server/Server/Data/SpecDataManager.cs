...
public partial class SpecDataManager
{
    ...
    async Task Fetch_Equipment()
    {
        ...
        try
        {
            ...
            List<string[]> rows = GvizParser.Parse(raw, colCount: 15);
            for (int i = 2; i < rows.Count; i++)
            {
                string[] cells = rows[i];
                if (string.IsNullOrEmpty(cells[0])) continue;
                ...
                // Attack (int)
                try { data.Attack = ParseInt(cells[9]); }
                catch (Exception e)
                {
                    Console.Error.WriteLine("[SpecDataManager] [Equipment] 파싱 오류\n" +
                        "  위치: 시트 행 " + sheetRow + ", 열 10 (Attack)\n" +
                        "  타입: int\n" +
                        "  값: \"" + cells[9] + "\"\n" +
                        "  원인: " + e.Message);
                    rowOk = false;
                ...
                // BaseSTR (int)
                try { data.BaseSTR = ParseInt(cells[11]); }
                catch (Exception e)
                {
                    Console.Error.WriteLine("[SpecDataManager] [Equipment] 파싱 오류\n" +
                        "  위치: 시트 행 " + sheetRow + ", 열 12 (BaseSTR)\n" +
                        "  타입: int\n" +
                        "  값: \"" + cells[11] + "\"\n" +
                        "  원인: " + e.Message);
                    rowOk = false;
                ...
                // BaseDEX (int)
                try { data.BaseDEX = ParseInt(cells[12]); }
                catch (Exception e)
                {
                    Console.Error.WriteLine("[SpecDataManager] [Equipment] 파싱 오류\n" +
                        "  위치: 시트 행 " + sheetRow + ", 열 13 (BaseDEX)\n" +
                        "  타입: int\n" +
                        "  값: \"" + cells[12] + "\"\n" +
                        "  원인: " + e.Message);
                    rowOk = false;
                ...
                // BaseINT (int)
                try { data.BaseINT = ParseInt(cells[13]); }
                catch (Exception e)
                {
                    Console.Error.WriteLine("[SpecDataManager] [Equipment] 파싱 오류\n" +
                        "  위치: 시트 행 " + sheetRow + ", 열 14 (BaseINT)\n" +
                        "  타입: int\n" +
                        "  값: \"" + cells[13] + "\"\n" +
                        "  원인: " + e.Message);
                    rowOk = false;
                ...
                // BaseLUK (int)
                try { data.BaseLUK = ParseInt(cells[14]); }
                catch (Exception e)
                {
                    Console.Error.WriteLine("[SpecDataManager] [Equipment] 파싱 오류\n" +
                        "  위치: 시트 행 " + sheetRow + ", 열 15 (BaseLUK)\n" +
                        "  타입: int\n" +
                        "  값: \"" + cells[14] + "\"\n" +
                        "  원인: " + e.Message);
                    rowOk = false;
    ...
    async Task Fetch_Player()
    {
        ...
        try
        {
            ...
            List<string[]> rows = GvizParser.Parse(raw, colCount: 17);
            for (int i = 2; i < rows.Count; i++)
            {
                string[] cells = rows[i];
                if (string.IsNullOrEmpty(cells[0])) continue;
                ...
                // PhysicalDamage (int)
                try { data.PhysicalDamage = ParseInt(cells[3]); }
                catch (Exception e)
                {
                    Console.Error.WriteLine("[SpecDataManager] [Player] 파싱 오류\n" +
                        "  위치: 시트 행 " + sheetRow + ", 열 4 (PhysicalDamage)\n" +
                        "  타입: int\n" +
                        "  값: \"" + cells[3] + "\"\n" +
                        "  원인: " + e.Message);
                    rowOk = false;
                ...
                // MagicDamage (int)
                try { data.MagicDamage = ParseInt(cells[4]); }
                catch (Exception e)
                {
                    Console.Error.WriteLine("[SpecDataManager] [Player] 파싱 오류\n" +
                        "  위치: 시트 행 " + sheetRow + ", 열 5 (MagicDamage)\n" +
                        "  타입: int\n" +
                        "  값: \"" + cells[4] + "\"\n" +
                        "  원인: " + e.Message);
                    rowOk = false;
                ...
                try { data.AttackHalfAngleDeg = ParseInt(cells[9]); }
                catch (Exception e)
                {
                    Console.Error.WriteLine("[SpecDataManager] [Player] 파싱 오류\n" +
                        "  위치: 시트 행 " + sheetRow + ", 열 10 (AttackHalfAngleDeg)\n" +
                        "  타입: int\n" +
                        "  값: \"" + cells[9] + "\"\n" +
                        "  원인: " + e.Message);
                    rowOk = false;
                ...
                // AttackHeight (int)
                try { data.AttackHeight = ParseInt(cells[10]); }
                catch (Exception e)
                {
                    Console.Error.WriteLine("[SpecDataManager] [Player] 파싱 오류\n" +
                        "  위치: 시트 행 " + sheetRow + ", 열 11 (AttackHeight)\n" +
                        "  타입: int\n" +
                        "  값: \"" + cells[10] + "\"\n" +
                        "  원인: " + e.Message);
                    rowOk = false;
                ...
                // CriticalRate (float)
                try { data.CriticalRate = ParseFloat(cells[15]); }
                catch (Exception e)
                {
                    Console.Error.WriteLine("[SpecDataManager] [Player] 파싱 오류\n" +
                        "  위치: 시트 행 " + sheetRow + ", 열 16 (CriticalRate)\n" +
                        "  타입: float\n" +
                        "  값: \"" + cells[15] + "\"\n" +
                        "  원인: " + e.Message);
                    rowOk = false;
                ...
                try { data.CriticalDamage = ParseFloat(cells[16]); }
                catch (Exception e)
                {
                    Console.Error.WriteLine("[SpecDataManager] [Player] 파싱 오류\n" +
                        "  위치: 시트 행 " + sheetRow + ", 열 17 (CriticalDamage)\n" +
                        "  타입: float\n" +
                        "  값: \"" + cells[16] + "\"\n" +
                        "  원인: " + e.Message);
                    rowOk = false;
